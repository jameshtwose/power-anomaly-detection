...
class AnomaliesTable(Base):
    ...
    elliptic_envelope_prediction = Column(Boolean)
    gaussian_scorer_prediction = Column(Boolean)
    half_space_trees_prediction = Column(Boolean)
    local_outlier_factor_prediction = Column(Boolean)
    one_class_svm_prediction = Column(Boolean)
